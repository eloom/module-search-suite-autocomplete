...
namespace Eloom\SearchSuiteAutocomplete\Block\Autocomplete;
...
use Eloom\SearchSuiteAutocomplete\Block\Product as ProductBlock;
...
class ProductAgregator extends DataObject {
	...
	public function getAddToCartData(): array {
		$formUrl = $this->productBlock->getAddToCartUrl(
			$this->getProduct(),
			['eloom_searchsuiteautocomplete' => true]
		);
