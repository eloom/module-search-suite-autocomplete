...
namespace Eloom\SearchSuiteAutocomplete\Model\Search;
...
use Eloom\SearchSuiteAutocomplete\Block\Autocomplete\ProductAgregator;
use Eloom\SearchSuiteAutocomplete\Helper\Data as HelperData;
use Eloom\SearchSuiteAutocomplete\Model\SearchInterface;
use Eloom\SearchSuiteAutocomplete\Model\Source\AutocompleteFields;
use Eloom\SearchSuiteAutocomplete\Model\Source\ProductFields;
...
class Product implements SearchInterface {
	...
	protected function getProductData(ProductModel $product): array {
		...
		$productAgregator = $this->objectManager->create(
			'Eloom\SearchSuiteAutocomplete\Block\Autocomplete\ProductAgregator'
		)
			->setProduct($product);
