...
namespace Eloom\SearchSuiteAutocomplete\Model;
	...
	public function create(string $param, array $arguments = []): SearchInterface {
		if (isset($this->map[$param])) {
			...
			$instance = $this->objectManager->create(
				'\Eloom\SearchSuiteAutocomplete\Model\Search\Suggested',
				$arguments
			);
		}
		...
		if (!$instance instanceof SearchInterface) {
			throw new UnexpectedValueException(
				'Class ' . get_class(
					$instance
				) . ' should be an instance of \Eloom\SearchSuiteAutocomplete\Model\SearchInterface'
			);
		}
