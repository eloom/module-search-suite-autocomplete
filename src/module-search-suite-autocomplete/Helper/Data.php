...
namespace Eloom\SearchSuiteAutocomplete\Helper;
...
class Data extends AbstractHelper {
	 ...
	 */
	const XML_PATH_SEARCH_DELAY = 'eloom_searchsuite/searchsuiteautocomplete_main/search_delay';

	/**
	 * XML config path autocomplete fields
	 */
	const XML_PATH_AUTOCOMPLETE_FIELDS = 'eloom_searchsuite/searchsuiteautocomplete_main/autocomplete_fields';

	/**
	 * XML config path suggest results number
	 */
	const XML_PATH_SUGGESTED_RESULT_NUMBER = 'eloom_searchsuite/searchsuiteautocomplete_main/suggested_result_number';

	/**
	 * XML config path product results number
	 */
	const XML_PATH_PRODUCT_RESULT_NUMBER = 'eloom_searchsuite/searchsuiteautocomplete_main/product_result_number';

	/**
	 * XML config path product result fields
	 */
	const XML_PATH_PRODUCT_RESULT_FIELDS = 'eloom_searchsuite/searchsuiteautocomplete_main/product_result_fields';
